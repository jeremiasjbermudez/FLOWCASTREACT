...
$result = $conn->query("SELECT * FROM Deposits ORDER BY DateAdded DESC");
...
foreach ($grouped as $account => $entries) {
    ...
    foreach ($entries as $row) {
        ...
        echo "<tr>
            ...
            <td>\${$row['Amount']}</td>
            <td>
                <a href='edit_deposit.php?id=$id' class='btn btn-warning btn-sm'>Edit</a>
                <a href='delete_deposit.php?id=$id' class='btn btn-danger btn-sm'>Delete</a>
            </td>
        </tr>";
    }
